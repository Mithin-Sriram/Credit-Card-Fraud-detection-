...
- 👩‍💻 Intern Name: Mithin Sriram V M 
-    Selected For: Artificial Intelligence
...
The system provides a **live dashboard experience similar to banking fraud monitoring systems** used in real financial institutions.

---

## 🎯 Key Features

- 🟢 Dataset-driven Safe Transaction Stream
- 🔴 Dataset-driven Fraud Detection Stream
- 📊 Real-time Analytics Dashboard
- 📈 Fraud vs Safe visualization (Pie Chart)
- 📉 Risk trend analysis (Line Chart)
- 🎨 FinTech Dark UI (Stripe-inspired design)
- 🔐 Login Authentication (Admin system)
- ⚡ No manual input required (fully automated simulation)
- 🧠 ML-powered fraud prediction system
